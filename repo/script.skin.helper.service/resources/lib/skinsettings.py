...
class SkinSettings:
    ...
    def write_skin_constants(self, constants=None, variables=None):
        ...
        if sys.version_info.major == 3:
            ...
            addonpath = try_decode(xbmcfvs.translatePath(try_encode(os.path.join("special://skin/", 'addon.xml'))))
            ...
            if extensionpoint.attrib.get("point") == "xbmc.gui.skin":
                ...
                for resolution in resolutions:
                    if sys.version_info.major == 3:
                        ...
                        includes_file = try_decode(xbmcfvs.translatePath(
                            try_encode(os.path.join(
                                "special://skin/",
                                try_decode(
                                    resolution.attrib.get("folder")),
    ...
    def get_skin_settings():
        ...
        if sys.version_info.major == 3:
            ...
            settings_file = try_decode(xbmcfvs.translatePath('special://skin/extras/skinsettings.xml'))
